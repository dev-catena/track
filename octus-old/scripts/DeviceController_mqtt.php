...
class DeviceController extends Controller
{
    ...
    public function saveTopic(Request $request)
    {
        try {
            ...
            ])->timeout(15)->post('http://181.215.135.118:8000/api/mqtt/mqtt/topics', $topicData);
    ...
    public function save(Request $request)
    {
        ...
        try {
            ...
            // 5. CRIAR TÓPICO MQTT
            $response = Http::timeout(15)->post('http://181.215.135.118:8000/api/mqtt/mqtt/topics', [
    ...
    public function registerDevice(Request $request)
    {
        try {
            ...
            try {
                $mqttResponse = Http::timeout(10)->post('http://181.215.135.118:8000/api/mqtt/mqtt/topics', [
                    'name' => $topicName,
                    'description' => $topicDescription
                ]);
    ...
    public function getDeviceTypes()
    {
        try {
            ...
            $apiUrl = config('app.api_base_url', 'http://181.215.135.118:8000/api/mqtt');
